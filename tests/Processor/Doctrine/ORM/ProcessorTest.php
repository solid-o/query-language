...
class ProcessorTest extends TestCase
{
    ...
    public function testManyToManyRelationFieldWorks(): void
    {
        ...
        self::assertStringContainsString('FROM User u0_ INNER JOIN user_group', self::$queryLogs[0]['sql']);
        self::assertStringContainsString('INNER JOIN u_group u1_', self::$queryLogs[0]['sql']);
        self::assertStringContainsString('GROUP BY u0_.id', self::$queryLogs[0]['sql']);
